...
class Solver(object):
    ...
    def vali(self, vali_loader):
        ...
        loss_1 = []
        loss_2 = []
        for i, (input_data_series, input_data_freq, _) in enumerate(vali_loader):
            ...
            rec_loss = self.criterion(output, input_data_series)
    ...
    def test(self):
        ...
        attens_energy = []
        for i, (input_data_series, input_data_freq, labels) in enumerate(self.thre_loader):
            input_data_series = input_data_series.float().to(self.device)
            input_data_freq = input_data_freq.float().to(self.device)
